    ...
    <div class="teachers-overview">
        <v-card>
            <v-data-table :headers="headers" :items="desserts" :search="search" sort-by="calories" class="elevation-1">
                <template v-slot:top>
                    <v-toolbar flat>
                        <v-toolbar-title color='teal' class="teachers-overview__card-title card-box-title">
                            <v-icon large dark>mdi-account-multiple</v-icon>
                        </v-toolbar-title>
                        <v-divider class="mx-4" inset vertical></v-divider>
                        <span>Teachers</span>
                        <v-spacer></v-spacer>
                        <v-text-field v-model="search" append-icon="mdi-magnify" label="Search" class="mr-5" single-line
                            hide-details>
                        </v-text-field>
                        <v-dialog v-model="dialog" max-width="500px">
                            <template v-slot:activator="{ on, attrs }">
                                <v-btn fab dark color='teal' class="mb-2" small depressed v-bind="attrs" v-on="on">
